import { Plus, Minus, Lock, MoreHorizontal, Check, Play } from 'lucide-react';
...
const LearningRoadmap = () => {
  ...
  return (
    <div className="max-w-2xl p-4 bg-gray-50 rounded-xl ">
      ...
      <div className="space-y-4">
        {courses.map((course, index) => (
          <div key={course.title} className="relative bg-white rounded-lg shadow-sm p-4">
            {index > 0 && (
